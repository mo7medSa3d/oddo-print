          ...
          <Card>
            <div className="p-5">
              ...
              <div className="mt-3 space-y-2">
                ...
                <div className="rounded-[8px] border border-bad-edge bg-bad-bg px-3 py-2 text-[11px]"><span className="font-semibold text-bad">INVALID CREDENTIAL</span><span className="text-ink-2"> — Key is missing or cannot authenticate</span></div>
                <div className="rounded-[8px] border border-bad-edge bg-bad-bg px-3 py-2 text-[11px]"><span className="font-semibold text-bad">Revoked credential</span><span className="text-ink-2"> — Key was explicitly revoked and cannot be used by Odoo.</span></div>
              </div>
            </div>
          </Card>
        </div>
