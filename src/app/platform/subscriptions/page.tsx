  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input type="text" value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Filter by tenant name, ID, or Stripe customer ID…" className="w-full rounded-[12px] border border-white/[0.08] bg-[#12151b] py-2.5 pl-10 pr-4 text-[13px] text-slate-100 placeholder-slate-500 outline-none focus:border-blue-500/30 focus:ring-2 focus:ring-blue-500/15" />
      </div>
